...
blackListTowns = ["kavala","pusta","abdera","athira","telos","sofia","paros","pyrgos","selakano","vikos","zaros","neochori","aggelochori","panochori","charkia","chalkeia","oreokastro","negades","molos"];// Remove towns from COS
