...
_setupObjects =
{
	...
	_heliChoices =
	[
		["O_Heli_Light_02_dynamicLoadout_F", ["orcaDAGR", "orcaDAGR"]],
		["O_Heli_Light_02_dynamicLoadout_F", ["O_Heli_Light_02_dynamicLoadout_F", "orcaDAGR"]],
		["O_Heli_Attack_02_dynamicLoadout_F", "O_Heli_Light_02_dynamicLoadout_F"]
	];

	if (missionDifficultyHard) then
	{
		(_heliChoices select 0) set [0, "O_Heli_Attack_02_dynamicLoadout_F"];
